    ...
    [
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["Plans", "Top nav pill to Plans & Pricing", "Plans button opens Plans & Pricing. Complimentary / assigned / affiliate access keeps the Plans label; hover to confirm it is not a paid subscription"],
            ["Contact Us", "Top nav link", "Use Contact Us or inbox"],
            ["Help Center", "Docs section", "Docs section + /contact"],
            ["Plan label", "Hidden", "Shows effective plan; click to open Account Billing. Hover to confirm complimentary / assigned / affiliate access is not a paid subscription"],
