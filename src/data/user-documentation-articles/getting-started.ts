    ...
    [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Open sign-up guide to walk through every screenshot in order, like a Flipvise UI guide. You may navigate anywhere in Flipvise while it remains open.",
        ],
      },
      {
        id: "guest-nav",
    ...
    [
      ...
      },
      {
        ...
        bullets: [
          ...
          "UI Guides — header button that lists every Flipvise UI guide (sign-up, sign-in, Personal Dashboard, and Pricing). Choose one to open the walkthrough; it stays open while you browse.",
