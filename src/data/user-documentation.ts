    ...
    pages: [
      ...
      },
      {
        ...
        howItWorks: [
          ...
          "Pro Plus and Education Plus deck owners see Format Quiz Question on the quiz lobby — open the dialog to enable formats, set question counts, generate AI sentences when needed, and reshuffle format questions.",
          "When a team admin (or you via Format Quiz Question) has set a question distribution and reshuffled, the lobby mix matches those exact counts.",
          "Each question shows a format badge (e.g. True / false, Fill in the blank) while you answer.",
          "When formats have been reshuffled, each card keeps its assigned format until reshuffled again; otherwise formats are chosen at random per card.",
        ...
        requirements: [
          ...
          "Format Quiz Question (personal decks) requires Pro Plus or Education Plus and deck ownership.",
