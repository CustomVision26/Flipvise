    ...
    <>
      ...
      >
        <Button
          ...
          variant="outline"
          size="icon"
          className="size-11 touch-manipulation active:scale-[0.98] transition-transform"
      ...
      <nav
        ...
        className="fixed inset-x-0 bottom-0 z-[200] border-t border-border bg-background/95 p-4 pb-[calc(1rem+var(--flipvise-safe-bottom,16px))] backdrop-blur-sm"
      >
        <Button
          type="button"
          variant="outline"
