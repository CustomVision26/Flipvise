  ...
  return (
    <>
      ...
      <ul className="space-y-1.5 text-xs">
        <li>
          <span className="font-semibold">Name/Subject/Deck:</span>{" "}
          <span className="font-medium">Mathematics</span>
          <br />
          <span className="font-semibold">Description/Topic:</span> Algebra, Geometry, or Calculus
        </li>
        <li>
          <span className="font-semibold">Name/Subject/Deck:</span>{" "}
          <span className="font-medium">Jamaican History</span>
          <br />
          <span className="font-semibold">Description/Topic:</span> Learning Jamaica&apos;s independence and
          national identity
        </li>
        <li>
          <span className="font-semibold">Name/Subject/Deck:</span>{" "}
          ...
          <br />
          <span className="font-semibold">Description/Topic:</span> Everyday French phrases and vocabulary
        </li>
      </ul>
    </>
  );
