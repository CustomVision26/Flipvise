...
import { tabPanelContentPadClass } from "@/lib/tab-panel-styles"
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:border-primary data-active:bg-background data-active:font-semibold data-active:text-foreground dark:data-active:bg-input/30 dark:data-active:text-foreground",
...
function TabsContent({ className, ...props }: TabsPrimitive.Panel.Props) {
  return (
    <TabsPrimitive.Panel
      ...
      className={cn(tabPanelContentPadClass, "flex-1 text-sm outline-none", className)}
      {...props}
    />
  )
}
