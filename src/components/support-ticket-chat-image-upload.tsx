...
type SupportTicketChatImageUploadProps = {
  ticketId: number;
  value: string | null;
...
export function SupportTicketChatImageUpload({
  ticketId,
  value,
  onChange,
  disabled = false,
  className,
}: SupportTicketChatImageUploadProps) {
  ...
  const handleFile = useCallback(
    async (file: File) => {
      ...
      try {
        ...
        const response = await fetch("/api/support-ticket/chat-image", {
          method: "POST",
          body: formData,
        });
